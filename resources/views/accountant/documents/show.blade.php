                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div>
                                ...
                                <dd class="mt-1 text-base text-gray-900 font-semibold px-2 py-1 bg-yellow-100 text-yellow-800 rounded-full {{ getStatusColorClass($document->status) }}">
                    ...
                    <div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-6 py-3 text-left text-base font-medium text-gray-500 uppercase">ລາຍລະອຽດ</th>
                                    <th class="px-6 py-3 text-right text-base font-medium text-gray-500 uppercase">ຈຳນວນ</th>
                                    <th class="px-6 py-3 text-right text-base font-medium text-gray-500 uppercase">ລາຄາຕໍ່ໜ່ວຍ</th>
                                    <th class="px-6 py-3 text-right text-base font-medium text-gray-500 uppercase">ລາຄາລວມ</th>
                                </tr>
                            </thead>
                    ...
                    @if(in_array($document->status, ['PENDING_ACCOUNTANT_BUDGET_CHECK', 'PENDING_ACCOUNTANT_POSTING']))
                        ...
                        <form action="{{ route('accountant.documents.process', $document->id) }}" method="POST">
                            ...
                            <div class="flex justify-end items-center space-x-4">
                                <a href="{{ route('accountant.dashboard') }}" class="btn-secondary inline-flex items-center px-4 py-2 bg-gray-400 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-500">ກັບຄືນ</a>
