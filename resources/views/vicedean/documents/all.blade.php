            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <x-document-filter-form 
                        :action="route('vicedean.documents.all')" {{-- ປ່ຽນເປັນ vicedean.documents.all ຫຼື headfinance.documents.all ຕາມບົດບາດ --}}
                            ...
                            @forelse ($documents as $document)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <a href="{{ route('vicedean.documents.show', $document->id) }}" class="text-indigo-600 hover:text-indigo-900">ເບິ່ງລາຍລະອຽດ</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
