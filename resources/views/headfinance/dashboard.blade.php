<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('ເອກະສານຂອງ ຫົວໜ້າພະແນກການເງິນ') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg rounded-xl border border-gray-200">
                <div class="p-4 sm:p-6 text-gray-900">
                    ...
                    <x-document-filter-form 
                        :action="route('headfinance.dashboard')" 
                        ...
                        @forelse ($pendingDocuments as $document)
                            <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm relative overflow-hidden">
                                ...
                                <div class="pt-2 pl-2 flex justify-end">
                                    <a href="{{ route('headfinance.documents.show', $document->id) }}" class="inline-flex items-center justify-center w-full sm:w-auto px-4 py-2.5 bg-indigo-600 text-white rounded-lg font-semibold text-sm hover:bg-indigo-700 shadow-sm transition">
