            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 space-y-6">
                    ...
                    @if($document->status === 'PENDING_FINANCE_HEAD_APPROVAL')
                        ...
                        <form action="{{ route('headfinance.documents.process', $document->id) }}" method="POST">
                            @csrf
                            ...
                            <div x-show="showRejectReason" x-transition class="mb-4">
                                <x-input-label for="rejection_reason" value="ເຫດຜົນທີ່ສົ່ງກັບ (ຕ້ອງລະບຸ)" />
                            ...
                            <div class="flex justify-end items-center space-x-4">
                                <a href="{{ route('headfinance.dashboard') }}" class="btn-secondary inline-flex items-center px-4 py-2 bg-gray-400 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-500">ກັບຄືນ</a>
