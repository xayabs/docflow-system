                        ...
                        class="mt-8 pt-6 border-t border-gray-200">
                            ...
                            <form action="{{ route('headfinance.documents.process', $document->id) }}" method="POST">
                                ...
                                <div class="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-end mt-8 gap-3 sm:space-x-4">
                                    <a href="{{ route('headfinance.dashboard') }}" class="w-full sm:w-auto text-center px-4 py-2.5 bg-gray-100 border border-gray-300 rounded-lg font-semibold text-sm text-gray-700 hover:bg-gray-200 transition">
                                        ກັບຄືນ
                                    </a>
