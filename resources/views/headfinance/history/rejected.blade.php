            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg rounded-xl border border-gray-200">
                <div class="p-4 sm:p-6 text-gray-900">
                    ...
                    <x-document-filter-form 
                        :action="route('headfinance.history.rejected')" 
                                ...
                                @forelse ($documents as $document)
                                    <tr class="bg-red-50/30 hover:bg-red-50/60 transition">
                                        ...
                                        <td class="px-6 py-4 text-center whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('headfinance.documents.show', $document->id) }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-900 bg-white px-3 py-1.5 rounded-lg border border-indigo-100 transition">
                                                ເບິ່ງລາຍລະອຽດ
                                            </a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-6 py-8 text-center text-gray-500">
                                            ບໍ່ມີປະວັດເອກະສານທີ່ຖືກປະຕິເສດ
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                        ...
                        @forelse ($documents as $document)
                            <div class="bg-white border border-red-200 rounded-xl p-4 shadow-sm relative overflow-hidden">
                                ...
                                <div class="flex justify-between items-start pl-2 mb-2">
                                    <span class="font-mono text-xs font-bold text-gray-700 bg-gray-100 border border-red-100 px-2 py-1 rounded">
                                ...
                                {{-- ລາຍລະອຽດ --}}
                                <div class="pl-2">
                                    <div class="grid grid-cols-2 gap-2 text-xs text-gray-600 bg-gray-50 p-2.5 rounded-lg border border-red-50">
                                        <div>
