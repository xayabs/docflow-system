                                ...
                                @forelse ($pendingDocuments as $document)
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-6 py-4 text-center whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('dean.documents.show', $document->id) }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-900 bg-indigo-50 px-3 py-1.5 rounded-lg border border-indigo-100 transition">
                    ...
                    <div class="block md:hidden space-y-4 mt-4">
                        @forelse ($pendingDocuments as $document)
                            <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm relative overflow-hidden">
                                ...
                                <div class="absolute top-0 left-0 w-1.5 h-full bg-amber-400 opacity-70"></div>
                                ...
                                <div class="pl-2">
                                    <div class="grid grid-cols-2 gap-2 text-xs text-gray-600 bg-gray-50 p-2.5 rounded-lg border border-gray-100">
                                        ...
                                        <div class="col-span-2 mt-1 pt-1 border-t border-gray-100">
                                            ...
                                            <span class="font-medium text-gray-800 truncate">{{ $document->requester->department->name ?? 'N/A' }}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="pt-3 mt-3 border-t border-gray-100 pl-2 flex justify-end">
                                    <a href="{{ route('dean.documents.show', $document->id) }}" class="inline-flex items-center text-sm font-semibold text-indigo-600 hover:text-indigo-800 bg-white px-4 py-2 rounded-lg border border-indigo-200 shadow-sm transition">
                                        ກວດສອບ ແລະ ດຳເນີນການ
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1.5" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd" /></svg>
                                    </a>
                                </div>
