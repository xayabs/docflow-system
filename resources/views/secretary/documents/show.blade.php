                ...
                <div class="p-6 text-gray-900 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div>
                                <dt class="text-sm font-medium text-gray-500">ສະຖານະ</dt>
                    ...
                    @if($document->status === 'PENDING_SECRETARY_REVIEW')
                        ...
                        <form action="{{ route('secretary.documents.process', $document->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="flex justify-end items-center space-x-4">
                                <a href="{{ route('secretary.dashboard') }}" class="btn-secondary inline-flex items-center px-4 py-2 bg-gray-400 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-500">ກັບຄືນ</a>
