                ...
                <div class="p-4 sm:p-6 text-gray-900 space-y-6 md:space-y-8">
                    ...
                    @if($document->document_type_id != 2)
                        <div>
                            ...
                            {{-- 2.1 ສ່ວນສະແດງຜົນເທິງຈໍຄອມ (Desktop Table) --}}
                            ...
                            {{-- 2.2 ສ່ວນສະແດງຜົນເທິງມືຖື (Mobile Cards) --}}
                    ...
                    @if($document->status === 'PENDING_SECRETARY_REVIEW')
                        ...
                        class="mt-8 pt-6 border-t border-gray-200">
                            ...
                            <h3 class="text-base md:text-lg font-bold mb-4 text-gray-800">ການດໍາເນີນການ</h3>
                            ...
                            <form action="{{ route('secretary.documents.process', $document->id) }}" method="POST">
                                        ...
                                        <template x-for="(noteSet, index) in notes" :key="index">
                                            <div class="p-4 bg-white rounded-lg shadow-sm border border-gray-200 relative">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    {{-- ປັບ Grid ຂອງ Checkbox ໃຫ້ພໍດີກັບຈໍມືຖື --}}
                                ...
                                <div class="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-end mt-8 gap-3 sm:gap-4 border-t pt-4">
                                    <a href="{{ route('secretary.dashboard') }}" class="w-full sm:w-auto text-center px-4 py-2.5 bg-gray-100 border border-gray-300 rounded-lg font-semibold text-sm text-gray-700 hover:bg-gray-200 transition">
                                        ກັບຄືນ
                                    </a>
