                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($documents as $document)
                                <tr>
                                    {{-- ... (แสดงข้อมูลเอกสาร) ... --}}
                                    <td class="px-6 py-4 font-mono text-center text-sm">{{ $document->document_code }}</td>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <a href="{{ route('secretary.documents.show', $document->id) }}" class="text-indigo-600 hover:text-indigo-900">ເບິ່ງລາຍລະອຽດ</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
