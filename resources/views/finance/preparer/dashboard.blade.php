<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('ເອກະສານຂອງ ຝ່າຍກະກຽມເອກະສານ') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-[90%] mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg rounded-xl border border-gray-200">
                <div class="p-4 sm:p-6 text-gray-900">
                    ...
                    <h3 class="text-lg font-medium mb-4">ລາຍການເອກະສານທີ່ລໍຖ້າກວດສອບລະບຽບການ</h3>
                    
                    {{-- ຟອມຄົ້ນຫາ ແລະ ກັ່ນຕອງ --}}
                    <x-document-filter-form 
                        :action="route('finance.preparer.dashboard')" 
                                ...
                                @forelse ($pendingDocuments as $document)
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('finance.preparer.documents.show', $document->id) }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-900 bg-indigo-50 px-3 py-1.5 rounded-lg border border-indigo-100 transition">
                        ...
                        @forelse ($pendingDocuments as $document)
                            <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm relative overflow-hidden">
                                ...
                                <div class="pt-2 pl-2 flex justify-end">
                                    <a href="{{ route('finance.preparer.documents.show', $document->id) }}" class="inline-flex items-center justify-center w-full sm:w-auto px-4 py-2.5 bg-indigo-600 text-white rounded-lg font-semibold text-sm hover:bg-indigo-700 shadow-sm transition">
