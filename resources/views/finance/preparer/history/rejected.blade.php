            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg rounded-xl border border-gray-200">
                <div class="p-4 sm:p-6 text-gray-900">
                    ...
                    <x-document-filter-form 
                        :action="route('finance.preparer.history.rejected')" 
                                ...
                                @forelse ($documents as $document)
                                    <tr class="bg-red-50/30 hover:bg-red-50/60 transition">
                                        ...
                                        <td class="px-6 py-4 text-center whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('finance.preparer.documents.show', $document->id) }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-900 bg-white px-3 py-1.5 rounded-lg border border-gray-200 shadow-sm transition hover:shadow">
                                                ເບິ່ງລາຍລະອຽດ
                                            </a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-6 py-8 text-center text-gray-500">
                                            ບໍ່ມີປະວັດເອກະສານທີ່ບໍ່ຖືກລະບຽບການ
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                        ...
                        @forelse ($documents as $document)
                            <div class="bg-red-50/20 border border-red-200 rounded-xl p-4 shadow-sm relative overflow-hidden">
                                ...
                                <div class="pt-3 mt-3 border-t border-red-100 pl-2 flex justify-end">
                                    <a href="{{ route('finance.preparer.documents.show', $document->id) }}" class="inline-flex items-center text-sm font-semibold text-red-600 hover:text-red-800 bg-white px-4 py-2 rounded-lg border border-red-200 shadow-sm transition">
                                        ເບິ່ງລາຍລະອຽດ
