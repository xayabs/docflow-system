                        ...
                        class="mt-8 pt-6 border-t border-gray-200">
                            ...
                            <form action="{{ route('finance.preparer.documents.process', $document->id) }}" method="POST">
                                        ...
                                        <template x-for="(noteSet, index) in notes" :key="index">
                                            <div class="p-4 bg-white rounded-lg shadow-sm border border-gray-200 relative">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 bg-gray-50 p-3 rounded border">
                                                        @if($recipientAccountant)
                                                            <label class="flex items-center p-2 hover:bg-white rounded cursor-pointer border border-transparent hover:border-gray-200 transition">
                                                                <input type="checkbox" :name="'notes[' + index + '][recipient_ids][]'" value="{{ $recipientAccountant->id }}" x-model="noteSet.recipient_ids" class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 w-4 h-4">
                                                                <span class="ml-2 text-sm text-gray-700">ນາຍບັນຊີ</span>
                                                            </label>
                                                        @endif
                                ...
                                <div class="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-end mt-8 gap-3 sm:gap-4 border-t pt-4">
                                    <a href="{{ route('finance.preparer.dashboard') }}" class="w-full sm:w-auto text-center px-4 py-2.5 bg-gray-100 border border-gray-300 rounded-lg font-semibold text-sm text-gray-700 hover:bg-gray-200 transition">
                                        ກັບຄືນ
                                    </a>
