...
<body>
        ...
        <table>
            ...
            <tfoot>
                <tr>
                    ...
                    <td></td> {{-- ເຊວຫວ່າງສໍາຫຼັບ "ຈໍານວນ" --}}
                    <td></td> {{-- ເຊວຫວ່າງສໍາຫຼັບ "ລາຄາຕໍ່ຫົວໜ່ວຍ" --}}
    ...
    <div class="lao-text" style="margin-top: 20px; float: right; width: 30%; text-align: right;">
        <p class="font-bold"><br>ຫົວໜ້າ{{ getDepartmentType($document->requester->department->name) }}</p>
        <br><br>
        <p>.........................</p>
    </div>
    <div class="lao-text" style="margin-top: 20px; float: right; width: 40%; text-align: center;">
        <p class="font-bold"><br>ນາຍບັນຊີ</p>
        <br><br>
        <p>.........................</p>
    </div>
    <div class="lao-text" style="margin-top: 20px; float: right; width: 30%; text-align: left;">
